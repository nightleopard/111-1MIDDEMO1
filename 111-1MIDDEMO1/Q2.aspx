...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            聯絡方式：
            <asp:RadioButtonList ID="rbl_Phone" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" OnSelectedIndexChanged="rbl_Phone_SelectedIndexChanged" AutoPostBack="True">
                <asp:ListItem Text="手機" Enabled="True" Selected="True"></asp:ListItem>
